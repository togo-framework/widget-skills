...
<div align="center">
  ...
  <h1>togo-framework/widget-skills</h1>
  <p>
    <a href="https://to-go.dev/marketplace"><img src="https://img.shields.io/badge/marketplace-to--go.dev-1F8A99" alt="marketplace" /></a>
    <a href="https://pkg.go.dev/github.com/togo-framework/widget-skills"><img src="https://pkg.go.dev/badge/github.com/togo-framework/widget-skills.svg" alt="pkg.go.dev" /></a>
...
```bash
togo install togo-framework/widget-skills
```
...
Top skills as medal chips ranked by proficiency.
